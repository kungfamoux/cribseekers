    ...
    <DashboardLayout role={role} userName={user?.firstName || "User"}>
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Manage your project revenue and withdrawals</p>
        </div>
          ...
          <>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{formatAmount(wallet.pendingSales)}</div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{formatAmount(wallet.totalRevenue)}</div>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              ...
              <Card className="hover:shadow-md transition-shadow cursor-pointer">
                <CardContent className="flex flex-col items-center justify-center py-6">
                  ...
                  <h3 className="font-semibold mb-1">Sales History</h3>
              ...
              <Card className="hover:shadow-md transition-shadow cursor-pointer">
                <CardContent className="flex flex-col items-center justify-center py-6">
                  ...
                  <h3 className="font-semibold mb-1">By Project</h3>
                  <p className="text-sm text-muted-foreground text-center">View by development project</p>
                </CardContent>
              </Card>
            </div>
            ...
            <Card>
              ...
              <CardContent>
                ...
                <div className="flex gap-2 mt-4">
                  ...
                  <Button variant="outline" size="sm" onClick={() => setWithdrawAmount("5000000")}>₦5,000,000</Button>
                  <Button variant="outline" size="sm" onClick={() => setWithdrawAmount("10000000")}>₦10,000,000</Button>
                  <Button variant="outline" size="sm" onClick={() => setWithdrawAmount("20000000")}>₦20,000,000</Button>
                </div>
              </CardContent>
            </Card>
