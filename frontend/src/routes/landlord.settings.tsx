          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Get notified when rent is paid</p>
              </div>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Make your profile visible to tenants and agents</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label htmlFor="property-visibility">Property Visibility</Label>
                <p className="text-sm text-muted-foreground">Show your properties in search results</p>
              </div>
              <Switch id="property-visibility" defaultChecked />
            </div>
            <Separator />
            <div className="flex items-center justify-between">
              <div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="business-name" defaultValue="Okafor Properties Ltd" />
            </div>
            <div className="space-y-2">
              <Label htmlFor="tax-number">Tax Number</Label>
              <Input id="tax-number" defaultValue="12345678-0001" />
            </div>
            <div className="space-y-2">
