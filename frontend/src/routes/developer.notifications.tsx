...
import { Bell, Check, Trash2, Calendar, DollarSign, Users, Building, MessageSquare } from "lucide-react";
...
function DeveloperNotifications() {
  ...
  useEffect(() => {
    async function fetchNotifications() {
      try {
        setLoading(true);
        setError(null);
        const result = await developerApi.notifications();
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Stay updated on your development activities</p>
          </div>
