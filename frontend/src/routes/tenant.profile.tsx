              ...
              <CardContent>
                <div className="grid gap-4 md:grid-cols-4">
                  <div className="text-center">
                    <p className="text-2xl font-bold">{user.activeRentals || 0}</p>
                    <p className="text-sm text-muted-foreground">Active Rentals</p>
                  </div>
                  <div className="text-center">
                    <p className="text-2xl font-bold">{user.monthlyRent || '₦0'}</p>
                    <p className="text-sm text-muted-foreground">Monthly Rent</p>
                  </div>
                  <div className="text-center">
                    <p className="text-2xl font-bold">{user.maintenanceRequests || 0}</p>
